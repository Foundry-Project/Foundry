...
//       try {
//         const id = await getOrCreateChatId(5);
//         setChatId(id);
//       } catch (error) {
...
//     if (message.trim()) {
//       try {
//         await sendMessage(chatId, message, 5);
//         setMessage('');
//       } catch (error) {
...
//   },
//   messageUser: {
//     backgroundColor: '#007bff', // Blue background for sent messages
//     borderRadius: 15,
//     padding: 10,
//     marginVertical: 5,
//     alignSelf: 'flex-start', // Align user message to the left
//     maxWidth: '70%',
//   },
//   messageAdmin: {
//     backgroundColor: '#e0e0e0', // Grey background for received messages
//     borderRadius: 15,
//     padding: 10,
//     marginVertical: 5,
//     alignSelf: 'flex-end', // Align admin message to the right
//     maxWidth: '70%',
//   },
//   messageUserText: {
...
//   },
//   messageUser: {
//     backgroundColor: '#black', // Updated background color for sent messages
//     borderRadius: 15,
//     padding: 10,
//     marginVertical: 5,
//     alignSelf: 'flex-start', // Align user message to the left
...
//   },
//   messageAdmin: {
//     backgroundColor: '#black', // Grey background for received messages
//     borderRadius: 15,
//     padding: 10,
//     marginVertical: 5,
//     alignSelf: 'flex-end', // Align admin message to the right
