...
import { AiOutlineCalendar, AiFillFile, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock } from 'react-icons/ai';
import { FiBox, FiPieChart, FiBarChart, FiCreditCard, FiDollarSign, FiPackage,FiUsers } from 'react-icons/fi';
import { BsFillTagFill, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield } from 'react-icons/bs';
...
export const areaPrimaryYAxis = {
  labelFormat: '{value} items',
  lineStyle: { width: 0 },
  maximum: 5,  // Adjusted maximum
  interval: 1,  // Adjusted interval
...
const areaChartData = [
  ...
  [
    ...
    { x: new Date(2004, 0, 1), y: 1.9 },
    { x: new Date(2005, 0, 1), y: 2.4 },
    { x: new Date(2006, 0, 1), y: 2.6 },
    { x: new Date(2007, 0, 1), y: 2.2 },
    { x: new Date(2008, 0, 1), y: 2.0 },
    { x: new Date(2009, 0, 1), y: 3.0 },
    { x: new Date(2010, 0, 1), y: 1.8 },
    { x: new Date(2011, 0, 1), y: 2.5 },
  ],
];
...
export const customersGrid = [
  ...
  { headerText: 'User Name', field: 'UserName', width: '150', textAlign: 'Center' },
  { headerText: 'User Email', field: 'UserEmail', width: '200', textAlign: 'Center' },
  { headerText: 'User Image', field: 'UserImage', width: '150', textAlign: 'Center', template: customerGridImage },
  { headerText: 'Item Name', field: 'ItemName', width: '150', textAlign: 'Center' },
  { field: 'Status', headerText: 'Status', width: '130', textAlign: 'Center', template: customerGridStatus },
  { field: 'DateFound', headerText: 'Date Found', width: '100', format: 'yMd', textAlign: 'Center' },
  { field: 'Location', headerText: 'Location', width: '150', textAlign: 'Center' },
  { field: 'UserID', headerText: 'User ID', width: '120', textAlign: 'Center', isPrimaryKey: true },
];

export const employeesGrid = [
  { field: 'image', headerText: 'image', width: '125', textAlign: 'Center' },
  { field: 'firstName', headerText: 'firstName', width: '170', textAlign: 'Center' },
  { field: 'lastName', headerText: 'lastName', width: '170', textAlign: 'Center' },
  { field:'email', headerText: 'email', width: '120', textAlign: 'Center' },
  { field: 'gender', headerText: 'gender', width: '135', format: 'yMd', textAlign: 'Center' },
  { field: 'phoneNumber', headerText: 'phoneNumber', width: '120', textAlign: 'Center' },
  { field: 'address', headerText: 'address', width: '125', textAlign: 'Center' },
  { field: 'role', headerText: 'role', width: '125', textAlign: 'Center' },
  { field: 'password', headerText: 'password', width: '125', textAlign: 'Center' },
];
...
export const links = [
  {
    ...
    links: [
      // {
      //   name: 'adminlogin', // Added AdminLogin page
      //   icon: <AiFillFile />,
      // },
      {
...
export const chatData = [
  {
    ...
    desc: 'A wallet was found in the manouba.',
    time: '9:08 AM',
  },
  {
    image: avatar3,
    message: 'Phone lost!',
    desc: 'A phone was found in the Gym ghazela.',
    time: '11:56 AM',
  },
  {
    image: avatar4,
    message: 'Keys found!',
    desc: 'A set of keys was reported lost in Tunis.',
    time: '4:39 AM',
  },
  {
    image: avatar,
    message: 'Backpack lost!',
    desc: 'A backpack was reported lost in Lycée khaznadar.',
    time: '1:12 AM',
  },
];
...
export const weeklyStats = [
  {
    ...
    desc: 'Total payments received for item deliveries',
    iconBg: '#FFB6C1',
    pcColor: 'green-600',
  },
  {
    ...
    amount: '+$3000',
    title: 'App Revenue',
    desc: 'Total revenue generated by the app',
    iconBg: '#FFD700',
    pcColor: 'green-600',
  },
  {
    ...
    desc: 'Number of items successfully delivered',
    iconBg: '#87CEEB',
    pcColor: 'blue-600',
  },
];
...
export const customersData = [
  ...
  },
  {
    ...
    Status: 'Found',
    StatusBg: '#8BE78B',
    DateFound: '2023-09-28',
    Location: 'Ben Arous',
  },
  {
    UserID: 1008,
    UserName: 'Hana Ben Youssef',
    UserEmail: 'hana@gmail.com',
    UserImage: avatar,
    ItemName: 'Backpack',
    Status: 'Lost',
    StatusBg: 'red',
    DateFound: '2023-09-22',
    Location: 'Manouba',
  },
  {
    UserID: 1009,
    UserName: 'Karim Jaziri',
...
const gridItemImage = (props) => (
  <div>
    <img src={props.ItemImage} alt="product" style={{ width: '100%' }} />
  </div>
);

const gridItemStatus = (props) => (
  <div style={{ color: props.StatusBg }}>
    {props.Status}
  </div>
);
...
export const lostAndFoundData = [
  {
    ItemID: 1,
    ItemName: 'Wallet',
    FoundLocation: 'Manouba',
    Status: 'Found',
    StatusBg: '#8BE78B',
    ItemImage: 'https://i.pinimg.com/236x/f5/71/33/f57133a1819ddeafad993dd63fe33cfe.jpg',
  },
  {
    ItemID: 2,
    ItemName: 'Keys',
    ...
    Status: 'Lost',
    StatusBg: '#FF5C8E',
    ItemImage: 'https://i.pinimg.com/236x/e0/24/0a/e0240a193244c0718c260bb61ed7474e.jpg',
  },
  {
    ItemID: 3,
    ItemName: 'Phone',
    FoundLocation: 'Gym Ghazela',
    Status: 'Found',
    StatusBg: '#8BE78B',
    ItemImage: 'https://i.pinimg.com/236x/1e/e2/73/1ee273e6921a62789276769d1e95d12e.jpg',
  },
  {
    ItemID: 4,
    ItemName: 'Backpack',
    FoundLocation: 'Lycée khaznadar',
    Status: 'Lost',
    StatusBg: '#FF5C8E',
    ItemImage: 'https://i.pinimg.com/236x/ec/ef/2d/ecef2df659218fffaf1925485bba1da5.jpg',
  },
  {
    ItemID: 5,
    ItemName: 'Glasses',
    FoundLocation: 'Cafée medina Arbi',
    Status: 'Found',
    StatusBg: '#8BE78B',
    ItemImage: 'https://i.pinimg.com/236x/6f/85/d2/6f85d2bc238c4648ec8b072fe6ea848a.jpg',
  },
  {
    ItemID: 6,
    ItemName: 'Watch',
    FoundLocation: 'Montazah Nahli',
    Status: 'Lost',
    StatusBg: '#FF5C8E',
    ItemImage: 'https://i.pinimg.com/236x/10/14/42/101442247a318ef4a2602172496eec69.jpg',
  },
  {
    ItemID: 7,
    ItemName: 'Notebook',
    FoundLocation: 'Beb Khadhra',
    Status: 'Found',
    StatusBg: '#8BE78B',
    ItemImage: 'https://i.pinimg.com/236x/cb/b3/21/cbb32107daca6091412024b0aad46be0.jpg',
  },
  {
    ItemID: 8,
    ItemName: 'Umbrella',
    ...
    Status: 'Lost',
    StatusBg: '#FF5C8E',
    ItemImage: 'https://i.pinimg.com/236x/2f/32/33/2f3233a2b3f280fedcccfa30522a9b33.jpg',
  },
  {
    ItemID: 9,
    ItemName: 'Headphones',
    FoundLocation: 'Ariana Soghra',
    Status: 'Found',
    StatusBg: '#8BE78B',
    ItemImage: 'https://i.pinimg.com/236x/1a/9c/a6/1a9ca60fc0e64b4fd2d8661efb5bc2f0.jpg',
  },
  {
    ItemID: 10,
    ItemName: 'Scarf',
    FoundLocation: 'avenue habib bourgiba',
    Status: 'Lost',
    StatusBg: '#FF5C8E',
    ItemImage: 'https://i.pinimg.com/236x/ac/b8/9b/acb89b49b70143d14cddf207a8def75a.jpg',
  },
];

export const lostAndFoundGrid = [
  {
    headerText: 'Image',
  ...
  {
    field: 'FoundLocation',
    headerText: 'Found Location',
    width: '150',
    textAlign: 'Center',
  },
  {
    headerText: 'Status',
    template: gridItemStatus,
    field: 'Status',
    textAlign: 'Center',
    width: '120',
  },
...
export const lineChartData = [
  [
    { x: new Date(2023, 9, 1), y: 5 }, // Manouba
    { x: new Date(2023, 9, 2), y: 3 },
    { x: new Date(2023, 9, 3), y: 4 },
    { x: new Date(2023, 9, 4), y: 2 },
    { x: new Date(2023, 9, 5), y: 6 },
  ],
  [
    { x: new Date(2023, 9, 1), y: 7 }, // Tunis
    { x: new Date(2023, 9, 2), y: 8 },
    { x: new Date(2023, 9, 3), y: 5 },
    { x: new Date(2023, 9, 4), y: 6 },
    { x: new Date(2023, 9, 5), y: 7 },
  ],
  [
    { x: new Date(2023, 9, 1), y: 2 }, // Ben Arous
    { x: new Date(2023, 9, 2), y: 3 },
    { x: new Date(2023, 9, 3), y: 1 },
    { x: new Date(2023, 9, 4), y: 4 },
    { x: new Date(2023, 9, 5), y: 2 },
  ],
  [
    { x: new Date(2023, 9, 1), y: 4 }, // Ariana
    { x: new Date(2023, 9, 2), y: 5 },
    { x: new Date(2023, 9, 3), y: 6 },
    { x: new Date(2023, 9, 4), y: 3 },
    { x: new Date(2023, 9, 5), y: 4 },
  ],
];
...
export const lostAndFoundDatas = [
  { x: 'Electronics', y: 40, text: '40%' },
  { x: 'Clothes', y: 30, text: '30%' },
  { x: 'Accessories', y: 20, text: '20%' },
  { x: 'Others', y: 10, text: '10%' },
];
...
export const stackedCustomSeries = [
  {
    dataSource: stackedChartData[1], // Update the data source
    xName: 'x',
    yName: 'y',
    name: 'Revenue from Returned Items', // Updated name
    type: 'StackingColumn',
    background: 'red',
  },
...
export const stackedPrimaryYAxis = {
  lineStyle: { width: 0 },
  minimum: 0, // Adjusted to fit revenue data
  maximum: 600, // Adjusted to fit revenue data
  interval: 100, // Adjusted to fit revenue data
  majorTickLines: { width: 0 },
  majorGridLines: { width: 1 },
  minorGridLines: { width: 1 },
  minorTickLines: { width: 0 },
  labelFormat: '{value} USD', // Adjusted to fit revenue data
};
...
export const PyramidData = [
  { x: 'scrafs', y: 120, text: '120 ' },
  { x: 'backbags', y: 435, text: '435 ' },
  { x: 'accessoires', y: 470, text: '470 ' },
  { x: 'keys', y: 475, text: '475 ' },
  { x: 'wallet', y: 520, text: '520 ' },
  { x: 'phones', y: 930, text: '930 ' },
];
